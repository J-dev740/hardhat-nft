...
<br/>
<p align="center">
<img src="./images/RandomIpfsNft/pug.png" width="225" alt="NFT Pug">

<img src="./images/RandomIpfsNft/shiba-inu.png" width="225" alt="NFT Shiba">

<img src="./images/RandomIpfsNft/st-bernard.png" width="225" alt="NFT St.Bernard">
</p>
<br/>
...
```
git clone https://github.com/J-dev740/hardhat-nft
cd hardhat-nft
npm install
```
...
Then run:
```
npx hardhat deploy --network sepolia --tags main
```
...
```
npx hardhat deploy --network sepolia --tags mint
```
